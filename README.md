...
Nusika is an adaptive learning engine that teaches you one concept at a time through **companions** — characters with their own personality, speech pattern, and teaching style. Think of it as a personal tutor that remembers everything about how you learn.

**Peh** is the central narrator — the voice you hear between sessions and at the gathering place (Ittunaha). Each subject has its own companion (Marcus for Latin, Wei for Mandarin, and many more) who guides you through lessons in their own style.

Under the hood, Nusika tracks your mastery through a clear progression: *introduced → practiced → mastered → reaffirmed*. Spaced repetition kicks in automatically — concepts you've mastered come back for review on a schedule so they stick. Hints are tiered (nudge, guided, direct) and tracked so companions learn how to help you best.

You can also save creative work — writing, translations, anything you produce while learning — and your companions remember what you've struggled with and what you've aced.
...
**Peh** is an open-source AI ecosystem — a family of tools that work together. Nusika is the learning engine; the other pieces handle different parts of the puzzle:
